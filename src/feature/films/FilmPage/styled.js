...
export const FilmBackdrop = styled.div`
...
export const FilmRatingImg = styled.img`
  height: 40px;
  width: auto;
...
export const FilmRatingNote = styled.p`
  font-weight: 500;
  font-size: 30px;
  line-height: 1.3;
  align-self: center;
...
export const FilmRatingTextVote = styled(FilmRatingText)`
  margin-top: 16px;
